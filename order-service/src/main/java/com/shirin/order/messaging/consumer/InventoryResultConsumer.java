...
//
//
//        InventoryReservedEvent event = toEvent(payload, InventoryReservedEvent.class);
//        validate(event);
...
//
//        InventoryReservationFailedEvent event = toEvent(payload, InventoryReservationFailedEvent.class);
//        validate(event);
